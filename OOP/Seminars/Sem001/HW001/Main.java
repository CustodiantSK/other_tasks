...
public class Main {
    public static void main(String[] args) {
        ...
        category1.addProduct(new Product("Телевизор", 29990.0, 4));
        category1.addProduct(new Product("Смартфон", 89990.0, 10));

        Category category2 = new Category("Одежда");
        category2.addProduct(new Product("Шорты", 1250.0, 3));
        category2.addProduct(new Product("Кеды", 985.0, 5));
        ...
        for (Product product : user1Products) {
            ...
            for (Product product2 : user2Products) {
                System.out.println(
                        "- " + product2.getName() + " - " + product2.getPrice() + " - " + product2.getRating());
